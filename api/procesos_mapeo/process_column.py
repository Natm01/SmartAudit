...
class AutomaticMapeoSession:
    ...
    def run_automatic_mapeo(self) -> Dict:
        """Run automatic mapeo process - SIMPLIFIED VERSION"""
        try:
            ...
            # Step 5: Create SINGLE output file
            output_result = self._create_output_files()
            
            # Step 6: Generate report WITHOUT balance
            ...
            result = {
                ...
                'manual_mapping_required': self.mapeo_stats['unmapped_columns'] > 0,
                'unmapped_fields_count': self.mapeo_stats['unmapped_columns']
            }
    ...
    def _create_output_files(self) -> Dict:
        ...
        try:
            result = self.csv_transformer.create_single_transformed_csv(
                self.df, 
                self.user_decisions, 
                suffix="mapped",
    ...
    def _create_basic_csv_fallback(self) -> Dict:
        ...
        try:
            ...
            # Apply numeric processing if available
            if hasattr(self.data_processor, 'process_numeric_fields_and_calculate_amounts'):
            ...
            return {
                ...
                'mapped_fields': len(self.user_decisions)
            }
