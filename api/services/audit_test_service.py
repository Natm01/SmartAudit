...
class AuditTestExecutionService:
    ...
    def insert_audit_test_exec_je_analysis(
        ...
        logger.info("=" * 80)
        logger.info("📋 PARÁMETROS DEL SP sp_insert_audit_test_exec_je_analysis:")
        logger.info("=" * 80)
        logger.info("👤 Usuario y Contexto:")
